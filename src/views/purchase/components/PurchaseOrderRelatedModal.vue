...
<template>
  ...
  >
          ...
          <n-card title="订单详情" :bordered="false" class="detail-card">
            <n-descriptions bordered :column="2" label-placement="left">
              ...
              <n-descriptions-item label="申请单号">
                <n-button v-if="detailData.applyOrderCode" text type="info" @click="openApply(detailData.applyOrderUid, detailData.applyOrderCode)">
                  {{ detailData.applyOrderCode }}
                </n-button>
                <span v-else>-</span>
              </n-descriptions-item>
              <n-descriptions-item label="来源订单">
                <n-button v-if="detailData.sourceOrderCode" text type="info" @click="openSourceOrder(detailData.sourceOrderUid, detailData.sourceOrderCode)">
    ...
    <PurchaseApplyRelatedModal
      ...
      :uid="relatedApply.uid"
      :code="relatedApply.code"
    />
